...
2. Download the `fujitsu_general_heatpump.py` from the repo and place it in the climate directory mentioned in previous step and rename it `climate.py`. So the end result would look like: `/config/custom_components/fujitsu_general_heatpump/climate.py`
